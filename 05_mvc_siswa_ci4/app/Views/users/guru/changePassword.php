...
<div class="profile-container">
    ...
    <form action="/guru/ubah-password" method="post" class="form-profile" id="formUbahPassword">
        <?= csrf_field() ?>
        ...
        <div class="form-buttons-profile">
            <a href="/guru/dashboard" class="btn-batal-profile">Batal</a>
...
<script src="<?= base_url('assets/js/users/guru/change-password.js') ?>"></script>
<?= $this->endSection() ?>